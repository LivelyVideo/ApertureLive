...
This privacy policy applies to the Aperture Live app (hereby referred to as "Application") for mobile devices that was created by Lively Video LLC (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".

OVERVIEW

Aperture Live is a mobile broadcasting application that enables you to stream live video to third-party platforms of your choice. This privacy policy explains what information we collect, how we use it, and what happens to your video content when you broadcast.

INFORMATION COLLECTION AND USE

The Application collects and processes the following information:

Device and Usage Information

When you download and use the Application, we may collect:
...
• Video is transmitted directly to the third-party platform you selected
• Lively Video does not control, store, or process your video after transmission
• Each platform has its own privacy policy governing how they handle your content
...
For questions about how a specific platform uses your video, please contact that platform directly or review their privacy policy.
...
The Application requires access to your device's camera and microphone to enable video broadcasting. This access is used solely for:
• Capturing video and audio for live broadcasting
• Enabling the face mask feature (optional)

You can revoke camera and microphone permissions at any time through your device's settings, though this will prevent the Application from functioning.
...
To stop broadcasting to a specific platform, simply stop your broadcast within the Application or disconnect from that platform.
...
The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discovers that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider at support@livelyvideo.tv so that we can take the necessary actions.

SECURITY

The Service Provider is concerned about safeguarding the confidentiality of your information. The Service Provider provides physical, electronic, and procedural safeguards to protect information the Service Provider processes and maintains.

Your video streams are transmitted using industry-standard encryption protocols. However, please be aware that once your video reaches a third-party platform, the security of that content is governed by that platform's security practices.

INTERNATIONAL DATA TRANSFERS

If you use the Application outside the United States, please be aware that your information may be transferred to, stored, and processed in the United States where our servers are located. By using the Application, you consent to the transfer of information to countries outside of your country of residence, which may have different data protection rules than your country.

Additionally, when you broadcast to third-party platforms, your video may be transmitted to servers in various countries depending on the platform you selected.
...
To exercise these rights, please contact us at support@livelyvideo.tv.

CALIFORNIA PRIVACY RIGHTS

If you are a California resident, you have specific rights under the California Consumer Privacy Act (CCPA). For more information about your California privacy rights, please contact us at support@livelyvideo.tv.
